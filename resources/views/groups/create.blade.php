...
<head>
    ...
    <style>
        ...
        .nav-btn.bold { font-weight: 600; border: none; background: none; cursor: pointer; }
    ...
    <form action="{{ route('groups.store') }}" method="POST">
        ...
        <div class="container">
            <div class="nav-bar">
                ...
                <span class="nav-title">New Group</span>
                <button type="submit" class="nav-btn bold">Save</button>
            </div>
